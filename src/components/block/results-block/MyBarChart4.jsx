...
const data = [
  ...
  const MyBarChart4 = () => {
    ...
    <div className='result-block__gistogram'>
        <BarChart  barCategoryGap={0} margin={{ top: 20, right: 30, left: 20, bottom: 5 }} width={200} height={80} data={data}>
        ...
        <Tooltip />
        <Legend />
        <Bar  minPointSize={0} shape={<CustomBar />} barSize={20} stroke="#000" dataKey="всего оценок" fill="#ffc658" />
      </BarChart>
